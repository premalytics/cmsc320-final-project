...
# Here we do random forest + PCA?/Logistic Regression?
```
...
rf_prediction <- randomForest(cluster~., ntree=200, importance=TRUE, data=training_data)
```
